...
<main class="container mt-4">
    <h1 class="text-center mb-4">Gerenciar Sistema</h1>
    <div class="btn-row">
        <div class="btn-col">
        ...
        <div class="btn-col">
            <a href="cidades.php" class="btn btn-custom btn-danger-custom">Cadastrar / Editar <br> Cidades</a>
        </div>
        <div class="btn-col">
            <a href="bairros.php" class="btn btn-custom btn-dark-custom">Cadastrar / Editar <br> Bairros</a>
        </div>
        <div class="btn-col">
            <a href="usuarios.php" class="btn btn-custom btn-info-custom">Cadastrar / Editar <br> Usuários</a>
        </div>
    </div>
	<br>
</main>
