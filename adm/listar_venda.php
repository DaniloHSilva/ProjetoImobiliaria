...
<html lang="pt-BR">
  ...
  <main class="container mt-4">
    ...
    <div id="content">
        <h2 class="text-center my-4">Lista de Imóveis Cadastrados para Venda</h2>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php
                        $query = "SELECT foto FROM venda WHERE id=$dado[id];";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript: if(confirm('Tem certeza que deseja deletar o Imóvel?')) location.href='del.php?id=<?php echo $dado["id"];?>'" class="btn btn-danger btn-sm">
                                EXCLUIR
                            </a>
                        </td>
                        <td>
                            <a href="edit.php?id=<?php echo $dado["id"]; ?>" class="btn btn-primary btn-sm">
                                Editar
                            </a>
                        </td>
                    </tr>
